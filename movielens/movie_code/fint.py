...
class FINT():
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            fint_output = fint_interaction_layer(self.embeddings, self.field_size, 1, self.l2_reg)
            fc_input = tf.reshape(fint_output, shape=[-1, self.field_size * self.embedding_size])

            # dnn part
            self.y_dense = fc_input
